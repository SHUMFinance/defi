      ...
      import abi from '../../lib/abis/bscmainnet/ShumDebtSystem';
  
      function ShumDebtSystem(contractSettings) {
        this.contractSettings = contractSettings || new ContractSettings();
  
        this.contract = new Contract(
          this.contractSettings.addressList['ShumDebtSystem'],
          abi,
      ...
      this.__ShumDebtSystem_init = async (_admin, txParams) => {
        txParams = txParams || {};
        return await this.contract.__ShumDebtSystem_init(_admin, txParams);
      };
