      ...
      import abi from '../../lib/abis/ethdev/sADA';
  
      function sADA(contractSettings) {
        this.contractSettings = contractSettings || new ContractSettings();
  
        this.contract = new Contract(
          this.contractSettings.addressList['sADA'],
          abi,
          this.contractSettings.signer || this.contractSettings.provider
        );
  
        
      this.__ShumAssetUpgradeable_init = async (_admin, txParams) => {
        txParams = txParams || {};
        return await this.contract.__ShumAssetUpgradeable_init(_admin, txParams);
      };
