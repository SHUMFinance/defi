      ...
      import abi from '../../lib/abis/ethdev/ShumConfig';


      //xxl
      console.log("xxl 001 abi ");
      console.log(abi);
      ...
      this.BUILD_RATIO = async (txParams) => {
        ...
        //xxl 
        console.log("xxl BUILD_RATIO start ");
          console.log(txParams);
          txParams = txParams || {};
          console.log("---------------------");
          let bRadio = await this.contract.BUILD_RATIO(txParams)
          console.log(bRadio);
        console.log("xxl BUILD_RATIO end ");
