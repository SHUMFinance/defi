...
<!--               </Tooltip>-->
            ...
            <div class="percentBox">
               <div class="cursorBox">
                  <div class="cursor"
                       :style="{left:cursorPosition+'%!important', marginLeft:cursorPosition>2?'-6px!important':'0px!important'}"></div>
               </div>
         ...
         <div class="totalBalanceToUSD">
            <div class="box">
               ...
               <div class="foot">
                  ...
                  <div class="refBtn">
                     <img src="@/static/appPage/Vectorrefs.svg" alt="">
                     <span>refresh</span>
                  </div>

<!--                  <svg class="refreshBtn"-->
<!--                      :class="{-->
