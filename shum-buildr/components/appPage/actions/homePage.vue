<template>
   <div id="homePage">
            ...
            <div class="content">
               ...
               <div class="context">
                  <template v-if="currentRatioStatus == 1">
                     ...
                     <span v-if="needBuyLINA">buy and stake {{formatNumber(needLINANum)}} SHUM</span><span v-else>stake {{formatNumber(needLINANum)}} SHUM</span>
                     or
                     <span v-if="needBuysUSD">buy and burn {{formatNumber(needsUSDNum)}} sUSD</span><span v-else>burn {{formatNumber(needsUSDNum)}} sUSD</span>
               ...
               <div class="btnBox">
                  ...
                  <div class="btn" v-if="!needBuyLINA && currentRatioStatus != 3" @click="actionLink(2)">Stake now →
                  </div>
                  <div class="btn" v-if="needBuysUSD && currentRatioStatus != 3" @click="actionLink(3)">Buy sUSD →</div>
                  <div class="btn" v-if="!needBuysUSD && currentRatioStatus != 3" @click="actionLink(4)">Burn now →
                  </div>
      ...
      <div class="context">
         ...
         <img src="@/static/Sfont5.png"/>USD. The collateral pool enables infinite liquidity and no
         slippage.
      </div>
      <div class="actionsBox">
         ...
         <div class="boxItem" @click="isMobile && btnClick(2)">
            ...
            <div class="boxContext">
               Stake Shum <br/>
               Build <img src="@/static/Sfont5.png"/>USD
            </div>
            <div
                class="btn"
                :class="{ isMobile }"
            ...
            >
               Build <img style="margin-left:5px;" src="@/static/Sfont.png"/>USD
            </div>
         </div>
      </div>
   </div>
