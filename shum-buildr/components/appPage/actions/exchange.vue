		...
		buildUsd: function() {
		 ...
		 lineChart() {
            ...
            this.myChart.setOption({
				...
				xAxis: {
					type: 'category',
					data: ['8am', '9am', '10am', '11am', '12am', '1pm', '2pm', '3pm', '4pm', '5pm', '6pm'],
					scale: false,
					boundaryGap: false,
					axisLine: { show: false },
...
.z-input-affix-wrapper {
	...
	&:focus, &.z-input-affix-wrapper-focused {
		border-color: #40a9ff;
		border-right-width: 1px!important;
		outline: 0;
		box-shadow: 0 0 0 2px rgba(24, 144, 255, .2);
