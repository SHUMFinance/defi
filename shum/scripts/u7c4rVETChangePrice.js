...
const main = async () => {
    ...
    //await shumOracleRouter.removeOracle(ethers.utils.formatBytes32String("sVET"));
    
    let price = await shumOracleRouter.getPrice(ethers.utils.formatBytes32String("sVET"));
