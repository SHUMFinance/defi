...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sTRX"), // key
    ...
    try{
        ...
        let beforesTRXBal = await sTRXToken.balanceOf(alice.address)
        console.log(beforesTRXBal);
        ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sTRX"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sTRXBala = await sTRXToken.balanceOf(alice.address)
        // console.log(sTRXBala);
        // ///---------------------------------------------------------------------
