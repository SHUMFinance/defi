...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sUNI"), // key
    ...
    try{
        ...
        let beforesUNIBal = await sUNIToken.balanceOf(alice.address)
        console.log(beforesUNIBal);
        // ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sUNI"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sUNIBala = await sUNIToken.balanceOf(alice.address)
        // console.log(sUNIBala);
        // ///---------------------------------------------------------------------
