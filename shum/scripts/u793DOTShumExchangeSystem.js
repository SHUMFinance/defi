...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sDOT"), // key
    ...
    try{
        ...
        let beforesDOTBal = await sDOTToken.balanceOf(alice.address)
        console.log(beforesDOTBal);
        // ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sDOT"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sDOTBala = await sDOTToken.balanceOf(alice.address)
        // console.log(sDOTBala);
        // ///---------------------------------------------------------------------
