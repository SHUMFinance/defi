...
const main = async () => {
    ...
    try{
        ...
        let beforesETHBal = await sETHToken.balanceOf(alice.address)
        console.log(beforesETHBal);
        ///---------------------------------------------------------------------
        // console.log("xxl before exchange :");
        ...
        // sETHBala = await sETHToken.balanceOf(alice.address)
        // console.log(sETHBala);
        // ///---------------------------------------------------------------------
