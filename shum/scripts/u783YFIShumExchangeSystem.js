...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sYFI"), // key
    ...
    try{
        ...
        let sYFITokenAddress = await readConfig("15config","sYFI");
        ...
        console.log(sYFITokenAddress);
        //4.0 set sYFI
        let sYFIToken = await ShumAssetUpgradeable.connect(admin).attach(
          sYFITokenAddress
        );
        ...
        let beforesYFIBal = await sYFIToken.balanceOf(alice.address)
        console.log(beforesYFIBal);
        // ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sYFI"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sYFIBala = await sYFIToken.balanceOf(alice.address)
        // console.log(sYFIBala);
        // ///---------------------------------------------------------------------
