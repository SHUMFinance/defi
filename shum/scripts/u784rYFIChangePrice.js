...
const main = async () => {
    ...
    // await writeConfig("15config","15config","TRXChainlink",chainlinkAggregator.address);
    // await sleep(2000);
    ...
    //await shumOracleRouter.removeOracle(ethers.utils.formatBytes32String("sYFI"));
    
    let price = await shumOracleRouter.getPrice(ethers.utils.formatBytes32String("sYFI"));
    ...
    // // Set token "sTRX" to use Chainlink
    // await shumOracleRouter.connect(admin).addChainlinkOracle(
    //     ethers.utils.formatBytes32String("sTRX"), // currencyKey
    ...
    //   1, // newRoundId
    //   expandToNDecimals(0.0924, 18), // newAnswer
    //   1, // newStartedAt
    //   200, // newUpdatedAt
