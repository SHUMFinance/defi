...
const main = async () => {
    ...
    /**
     * Create synthetic asset sLINK
     */
    const sLINKToken = await upgrades.deployProxy(
        ShumAssetUpgradeable,
        [
            ethers.utils.formatBytes32String("sLINK"), // bytes32 _key,
            "sLINK", // _name,
            "sLINK", // _symbol
    ...
    console.log("✓ 15 ShumAssetUpgradeable sLINK deployed ")
    console.log(sLINKToken.address);
    console.log("");  

    await writeConfig("15config","15config","sLINK",sLINKToken.address);
    await sleep(2000);
