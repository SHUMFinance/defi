...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sVET"), // key
    ...
    try{
        ...
        let sVETTokenAddress = await readConfig("15config","sVET");
        ...
        console.log(sVETTokenAddress);
        //4.0 set sVET
        let sVETToken = await ShumAssetUpgradeable.connect(admin).attach(
          sVETTokenAddress
        );
        ...
        let beforesVETBal = await sVETToken.balanceOf(alice.address)
        console.log(beforesVETBal);
        ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sVET"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sVETBala = await sVETToken.balanceOf(alice.address)
        // console.log(sVETBala);
        // ///---------------------------------------------------------------------
