...
const main = async () => {
    ...
    await shumConfig.connect(admin).setUint(
      ethers.utils.formatBytes32String("sEUR"), // key
    ...
    try{
        ...
        let sEURTokenAddress = await readConfig("15config","sEUR");
        ...
        console.log(sEURTokenAddress);
        //4.0 set sEUR
        let sEURToken = await ShumAssetUpgradeable.connect(admin).attach(
          sEURTokenAddress
        );
        ...
        let beforesEURBal = await sEURToken.balanceOf(alice.address)
        console.log(beforesEURBal);
        ///---------------------------------------------------------------------
        ...
        //   ethers.utils.formatBytes32String("sEUR"),   // destKey
        //   {gasLimit: args.gasLimit}
        ...
        // sEURBala = await sEURToken.balanceOf(alice.address)
        // console.log(sEURBala);
        // ///---------------------------------------------------------------------
